...
//        WebDriver driver = new ChromeDriver(options);
        ...
        By nextButton = By.cssSelector("[id='next']");

        By nextText = By.cssSelector("[id='next']");
        By beforeButton = By.cssSelector("[id='before']");

        driver.findElement(nextText).sendKeys("Text");
        driver.findElement(beforeButton).click();

        driver.findElement(By.cssSelector("[id='next']")).click();
        driver.findElement(By.cssSelector("[id='before']")).sendKeys("Text");
